...
modelfilename = "Test_Coloring_VQE_2"
...
def objective(trial: Trial):
    ...
    kwargs = {}
    kwargs.update(VQEColoringSolver_FeasibleNbColor.get_default_hyperparameters())

    # solver init
    solver = solver_class(problem=problem, nb_color=nb_max_color)
    solver.init_model()
